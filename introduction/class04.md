...
- NetLogo basics—interface, parameters, behaviors.
- Commands, procedures, and the NetLogo language.
- Running and modifying simple models.

---

## 🖥️ Session B (Lab)

Micro-exercise: Adjust one parameter in a simple model, note results.

---

(lab-memo-1)=
## 👷🏽‍♀️ **Assignment:** Lab Memo #1
